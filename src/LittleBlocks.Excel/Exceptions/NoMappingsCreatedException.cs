...
{
    public sealed class NoMappingsCreatedException<TModel> : ExcelException where TModel : class
    {
        public NoMappingsCreatedException(string sheetName, string workbookTitle)
            : base(GetMessage(sheetName, workbookTitle))
        {
        }
